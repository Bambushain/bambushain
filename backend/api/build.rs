...
fn main() {
    let common_dependencies = get_dependencies_from_cargo_lock(format!(
        "{}/../../common/Cargo.toml",
    ...
    println!("cargo:rerun-if-changed=../../../common/Cargo.toml");
    println!("cargo:rerun-if-changed=../../../common/Cargo.lock");
