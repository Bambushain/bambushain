...
fn validate_savage_mount_dir() -> String {
    let path = join_paths(vec![validate_database_dir(), "savageMount".to_string()]).expect("Paths should be able to join").into_string().expect("String should be available as core string");
...
pub fn create_savage_mount(savage_mount: &String) -> EmptyResult {
    let path = join_paths(vec![validate_savage_mount_dir(), savage_mount.to_string()]).expect("Paths should be able to join").into_string().expect("String should be available as core string");
...
pub fn update_savage_mount(savage_mount: &String, new_name: &String) -> EmptyResult {
    let old_path = join_paths(vec![validate_savage_mount_dir(), savage_mount.to_string()]).expect("Paths should be able to join").into_string().expect("String should be available as core string");
    let new_path = join_paths(vec![validate_savage_mount_dir(), new_name.to_string()]).expect("Paths should be able to join").into_string().expect("String should be available as core string");
...
pub fn activate_savage_mount_for_user(savage_mount: &String, username: &String) -> EmptyResult {
    let path = join_paths(vec![validate_savage_mount_dir(), savage_mount.to_string(), username.to_string()]).expect("Paths should be able to join").into_string().expect("String should be available as core string");
...
pub fn get_savage_mounts_for_user(username: &String) -> Option<impl Iterator<Item=String> + '_> {
    ...
    Some(savage_mounts.filter_map(|savage_mount| {
        let savage_mount_path = join_paths(vec![validate_savage_mount_dir(), savage_mount.to_string(), username.to_string()]).expect("Paths should be able to join");
